...
emcc -O3 -lc -r libfoo.cpp -o libfoo.o && emar rcs libfoo.a libfoo.o && emcc libfoo.o -o libfoo.js && wasm-pack build --target web && wasm2wat pkg/rust_wasm_cpp_bg.wasm | grep "(import "
